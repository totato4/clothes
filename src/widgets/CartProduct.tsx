...
import { IProduct } from "../RTK/asyncThunk/types";
import { useAppDispatch } from "../RTK/store";
import { minusItem, plusItem, removeCart } from "../RTK/cart/cartSlice";
import RadioButton from "../components/CartPage/RadioButton";
...
const CartProduct: React.FC<props> = ({ children }) => {
      ...
      <div className=" pr-4 my-auto">
        <div className="flex flex-col items-center justify-center gap-y-3">
          ...
          <div className="text-xs">
            <CartButton handleClick={removeCard}>Убрать товар</CartButton>
          </div>
        </div>
      </div>
    </div>
