...
const arrayColor = [
  ...
  { name: "синий", quantity: 15678, arrayName: "Color" },
  { name: "зеленый", quantity: 35678, arrayName: "Color" },
  { name: "желтый", quantity: 75678, arrayName: "Color" },
  { name: "черный", quantity: 95678, arrayName: "Color" },
  { name: "оранжевый", quantity: 115678, arrayName: "Color" },
  { name: "серый", quantity: 245678, arrayName: "Color" },
];

const arraySize = [
  { name: "XS", quantity: 753, arrayName: "Size" },
  { name: "S", quantity: 6435, arrayName: "Size" },
  { name: "M", quantity: 2350, arrayName: "Size" },
